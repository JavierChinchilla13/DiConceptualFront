...
public class ProjectController implements Serializable {
    ...
    public void deleteFeedback() throws Exception {
        ...
        try {
            System.out.println(selectedFeedback.getId());
            FeedbackTO f = new FeedbackTO(this.selectedFeedback.getId(), this.selectedFeedback.getName(), this.selectedFeedback.getDescription(), this.selectedFeedback.getDateOfFeedback(), this.selectedFeedback.getIdStatus(), 21, this.selectedFeedback.getIdCreator());
            fService.delete(f);
